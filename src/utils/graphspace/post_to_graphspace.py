...
def readGraphAttr(graph_attr_file):
    ...
    print("Adding graph attributes from '%s' (must have 4 tab-delimited columns)" % (graph_attr_file))
...
def set_edge_width(edges, edge_weights, graph_attr, a=1, b=12):
    """
...
def buildNodePopup(n, uniprot=True, attr_val=None):
    """
